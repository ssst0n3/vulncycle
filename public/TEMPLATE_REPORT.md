...
- **受影响版本**: TODO: vX.Y.Z – vX.Y.Z
- **CVSS**: TODO: 0.0 CVSS:4.0/AV:?/...
- **攻击者权限**: TODO: 权限下界（如 租户级 / 任一已认证账号）
- **危害概要**: TODO: 一句话
...
- **修复PR**: TODO: #XXX
- **修复时间**: TODO: YYYY-MM-DD
- **修复版本**: TODO: vX.Y.Z（未修复时填 unfixed）
- **修复者**: TODO: name
- **Backport状态**: TODO: 如 无（release-x.y 均未回填）/ 已回填至 vX.Y
